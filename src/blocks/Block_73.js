...
export const Block_73 = ({ is_selected, color }) => {
  ...
  const draw = () => {
    ...
    context.fillStyle = get_invert_color(color)
...
const Input =
  Component.absolute.b20.l20.sans.ol_none.b_rad50.ba0.pv10.ph15.fs17.w50p.input()
const Button =
  Component.c_pointer.b_rad50.pv10.ph20.fs15.ba0.bg_white.mono.absolute.b20.r20.button()
